...
echo "$($PSQL "SELECT t.name from teams t, games g where g.round = 'Final' and g.winner_id = t.team_id and g.year = 2018")"

echo -e "\nList of teams who played in the 2014 'Eighth-Final' round:"
echo "$($PSQL "select distinct t.name from teams t, games g where g.round = 'Eighth-Final' and (g.winner_id = t.team_id or g.opponent_id = t.team_id) and g.year = 2014 ORDER BY name ASC")"
